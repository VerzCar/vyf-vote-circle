module github.com/VerzCar/vyf-vote-circle
...
require (
	...
	golang.org/x/sys v0.21.0 // indirect; indirectq
...
require (
	github.com/VerzCar/vyf-lib-awsx v1.3.8
	github.com/VerzCar/vyf-lib-logger v1.1.0
	github.com/ably/ably-go v1.2.17
